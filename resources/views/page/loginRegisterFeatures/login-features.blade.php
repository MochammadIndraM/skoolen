...
@section('content')
    <section class="flex flex-col justify-center items-center h-screen w-screen">
        <form action="{{ route('loginFeatures.Login.post') }}" method="POST"
            ...
            <div class="text-red-600 text-[20px] flex justify-center">
            ...
            <div class="flex justify-center items-center mt-[10px]">
                <button
                    class="bg-green-300 tracking-wider text-green-900 font-bold text-[25px] px-[20px] py-[10px] rounded-lg border border-green-200 shadow-lg shadow-black transition-transform duration-300 transform hover:scale-90">
                    LOGIN
                </button>
            </div>
        </form>
