...
Route::middleware([AdminMiddleware::class])->group(function () {
    ...
    Route::post('/fitur-langit/add', [FiturLangitController::class, 'store'])->name('Admin.fitur-langit.store');
    Route::get('/fitur-langit/{id}/langit', [FiturLangitController::class, 'byId'])->name('Admin.fitur-langit.byId');
    Route::post('/fitur-langit/update/{id}', [FiturLangitController::class, 'update'])->name('Admin.fitur-langit.update');
    Route::delete('/fitur-langit/destroy/{id}', [FiturLangitController::class, 'destroy'])->name('Admin.fitur-langit.destroy');
