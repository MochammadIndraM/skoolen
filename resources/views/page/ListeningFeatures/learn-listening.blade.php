        ...
        <div class="playButton">
            <div class="container">
                <div class="box center">
                    <audio id="audio" src="{{ asset('assets/voice/telur.mp3') }}"></audio>
                </div>
            </div>
        </div>
        <div class="questionContainer">
            <h1>APA YANG IBU GORENG?</h1>
        </div>
        <div class="answerContainer">
            <div class="answer" data-answer="beras">
                <img src="{{ asset('assets/img/listening-features/beras.png') }}" alt="Beras">
                <p>Beras</p>
            </div>
            <div class="answer" data-answer="jagung">
                <img src="{{ asset('assets/img/listening-features/jagung.png') }}" alt="Jagung">
                <p>Jagung</p>
            </div>
            <div class="answer" data-answer="jambu">
                <img src="{{ asset('assets/img/listening-features/jambu.png') }}" alt="Jambu">
                <p>Jambu</p>
            </div>
            <div class="answer" data-answer="telur">
                <img src="{{ asset('assets/img/listening-features/telur.png') }}" alt="Telur">
                <p>Telur</p>
            </div>
        </div>
        <!-- Pesan jawaban -->
        <div id="answerFeedback" class="answerFeedback"></div>
        <a href="{{ route('listeningFeatures2') }}" class="nextButton" id="nextButton">Selanjutnya</a>
    </div>
    <script>
        ...
        answers.forEach(answer => {
            answer.addEventListener('click', () => {
                ...
                if (selectedAnswer === 'telur') { // Ubah ini sesuai dengan jawaban yang benar
