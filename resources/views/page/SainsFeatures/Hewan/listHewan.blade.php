                    ...
                    <a href="{{ route('sainsFeatures.detailHewan', $item->nama_hewan) }}"
                        ...
                        <div class="w-full overflow-hidden rounded-t-3xl ">
                            <img src="/assets/img/sains/hewan/{{ $item->gambar }}"
                                class="w-full h-[200px] md:h-[300px] lg:h-[400px] object-cover" alt="{{ $item->nama_hewan }}">
                        </div>
                        <p class="text-[#FFFF80] text-[34px] md:text-[44px] lg:text-[54px] pt-[20px]">{{ $item->nama_hewan }}</p>
                    </a>
                </div>
            @endforeach
        </div>
