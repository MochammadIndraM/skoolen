...
@section('content')
    <style type="text/css">
        .body {
            ...
            padding-top: 50px;
            margin: 0px;
            background-image: url('{{ asset('assets/background/background_jam.png') }}');
        ...
        .w3-bar-item input[type=number]:focus {
            border-color: #000000;
            /* Warna border hijau gelap saat fokus */
            outline: none;
    ...
    <section class="body">
        <div class="title-container">
            <h2 class="text-2xl text-justify border-b-4 border-red-300 pb-1 px-4 rounded-md" style="display: inline-block">
                Mari Kita Belajar Jam</h2>
        </div>
                ...
                <div class="inputContainer">
                    <div class="w3-bar-block">
                        <div class="w3-bar-item">
                            ...
                            <input id="valHour" class="w3-input w3-border" type="number" min="0" max="23"
                                required>
                        </div>
                        <div class="w3-bar-item">
                            <label for="valMinute">Menit:</label>
                            <input id="valMinute" class="w3-input w3-border" type="number" min="0" max="59"
                                required>
                        </div>
                    </div>
                </div>
                <div id="alertMessage" class="alert-message hidden" style="font-size: 200%;">Jam dan menit harus diisi.
                </div>
    ...
    <script src="{{ asset('js/clock-system.js') }}"></script>
    <script>
        'use strict';
