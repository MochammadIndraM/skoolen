        ...
        <div class="playButton">
            <div class="container">
                <div class="box center">
                    <audio id="audio" src="{{ asset('assets/voice/kereta.mp3') }}"></audio>
                </div>
            </div>
        </div>
        <div class="questionContainer">
            <h1>AYAH DAN IBU NAIK APA?</h1>
        </div>
        <div class="answerContainer">
            <div class="answer" data-answer="mobil">
                <img src="{{ asset('assets/img/listening-features/mobil.png') }}" alt="Mobil">
                <p>Mobil</p>
            </div>
            <div class="answer" data-answer="kereta">
                <img src="{{ asset('assets/img/listening-features/kereta.png') }}" alt="Kereta">
                <p>Kereta</p>
            </div>
            <div class="answer" data-answer="kapal">
                <img src="{{ asset('assets/img/listening-features/kapal.png') }}" alt="Kapal">
                <p>Kapal</p>
            </div>
            <div class="answer" data-answer="motor">
                <img src="{{ asset('assets/img/listening-features/motor.png') }}" alt="Motor">
                <p>Motor</p>
            </div>
        </div>

        <div id="answerFeedback" class="answerFeedback"></div>
        <a href="{{ route('listeningFeatures3') }}" class="nextButton" id="nextButton">Selanjutnya</a>
    </div>
    ...
    <script>
        ...
        answers.forEach(answer => {
            answer.addEventListener('click', () => {
                ...
                if (selectedAnswer === 'kereta') { // Ubah ini sesuai dengan jawaban yang benar
                    showAnswerFeedback('Jawaban Benar', 'correct');
                    document.getElementById('nextButton').style.display = 'block'; // Tampilkan tombol Next jika jawaban benar
                } else {
