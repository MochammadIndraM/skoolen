                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 py-4">
                    <a href="{{ route('sainsFeatures.detailTumbuhan', $item->nama_tumbuhan) }}"
                        ...
                        <div class="w-full overflow-hidden rounded-t-3xl ">
                            <img src="/assets/img/sains/tumbuhan/{{ $item->gambar }}"
                                class="w-full h-[200px] md:h-[300px] lg:h-[400px] object-cover" alt="{{ $item->nama_tumbuhan }}">
                        </div>
                        <p class="text-[#FFFF80] text-[34px] md:text-[44px] lg:text-[54px] pt-[20px] text-center">{{ $item->nama_tumbuhan }}</p>
                    </a>
                </div>
            @endforeach
        </div>
